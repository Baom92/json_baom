 ...
 * @author Bello
 */
public class Fournisseur_json implements Serializable {

    private String chaine = "{\n";

    public Fournisseur_json(Fournisseur fournisseur, List<Projet> projets, List<Programme> programmes) {
        this.chaine += "\t\"id\": " + fournisseur.getId() + ",\n";
        this.chaine += "\t\"nom\": \"" + fournisseur.getNom() + "\",\n";
